...
{- | Servant API type definition for the insight-collector service.

 Defines 'InsightCollectorAPI' as the business API (excluding the standard health
...
{- | The insight-collector business API.
...
-}
type InsightCollectorAPI =
  "pubsub"
    :> "events"
    :> ReqBody '[JSON] Value
    :> Post '[JSON] PubSubPushResponse

insightCollectorApiProxy :: Proxy InsightCollectorAPI
insightCollectorApiProxy = Proxy
...
insightCollectorServer :: AppEnv -> Server InsightCollectorAPI
insightCollectorServer = pubSubPushHandler
