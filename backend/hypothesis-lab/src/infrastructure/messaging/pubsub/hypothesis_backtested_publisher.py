"""Pub/Sub publisher for hypothesis.backtested events."""
...
class HypothesisBacktestedPublisher:
    """Publishes HypothesisBacktested domain events to Pub/Sub as CloudEvents."""

    def __init__(self, client: PublisherClient, topic_path: str) -> None:
        self._client = client
        self._topic_path = topic_path

    def publish(self, event: HypothesisBacktested) -> str:
        """Publish a HypothesisBacktested event to Pub/Sub.
