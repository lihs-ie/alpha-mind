...
最終更新日: 2026-02-12
JSON対応: `内部設計/json/svc-execution.json`

## 1. サービス概要

- サービスID: `svc-execution`
...
- Firestore: `orders`, `audit_logs`, `idempotency_keys`
...
- 冪等性キー: `eventId`
- ガード: 同一eventIdで外部発注を再実行しない
- リトライ: 最大3回、指数バックオフ
- 非再試行: `insufficient_funds`, `invalid_symbol`, `market_closed`
